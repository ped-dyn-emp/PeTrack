...
Uncheck the boxes `active` in the recognition and tracking tab.

:::{Important}
If you don’t uncheck `active` (for both recognition and tracking) you will overwrite the previously tracked trajectories!
:::
