...
The easiest way to get the correct formatting is setting up `clang-format-21`. With the provided `.clang-format` file the files then can be formatted correctly.
